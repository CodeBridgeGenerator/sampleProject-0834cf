...
import seederData from "./incidents.seeder.json";
...
const IncidentsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IncidentsSeederDialogComponent);
