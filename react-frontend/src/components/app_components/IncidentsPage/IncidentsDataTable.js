...
const IncidentsDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
  ...
  const handleHideDialog = () => {
    ...
    return (
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Incidents Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search Incidents" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
