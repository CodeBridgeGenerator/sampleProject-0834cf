...
import seederData from "./vendors.seeder.json";
...
const VendorsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(VendorsSeederDialogComponent);
