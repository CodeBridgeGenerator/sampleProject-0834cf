...
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.active}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="active" header="Active" body={pTemplate3} filter={selectedFilterFields.includes("active")} hidden={selectedHideFields?.includes("active")}  sortable style={{ minWidth: "8rem" }} />
